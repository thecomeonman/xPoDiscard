...
createPanelParent = function(
    ...
    if ( true ) {
        ...
        d3.select("#" + cContentPanelId).append("p")
            ...
            .attr('class','TeamScoringPost setSpecificContent Liverpool_For_Scoring_Team')
        ...
        d3.select("#" + cContentPanelId).append("p")
            ...
            .attr('class','TeamScoringPost setSpecificContent ManUtd_For_Scoring_Team')
        ...
        d3.select("#" + cContentPanelId).append("p")
            ...
            .attr('class','PlayerScoringPost setSpecificContent Liverpool_For_Scoring_Player_MohamedSalah')
        ...
        d3.select("#" + cContentPanelId).append("p")
            ...
            .attr('class','PlayerScoringPost setSpecificContent Liverpool_For_Scoring_Player_TrentAlexander-Arnold')
    ...
    if ( true ) {
        ...
        d3.select("#" + cContentPanelId).append("p")
            .text(
                "\
                Except for a blog slightly to the right, on the edge of the final\
    ...
    if ( true ) {
        ...
        d3.select("#" + cContentPanelId).append("p")
            .text(
                ...
                but his contribution is far from the right wing from a little before\
                the halfway line all the way to the edge of the final third.\
                "
            )
            .attr('class','PlayerScoringPost setSpecificContent Liverpool_For_Scoring_Player_TrentAlexander-Arnold')
                ...
                d3.csv('./Data/' + setCode.replace(/_/g,'/') + '/OriginProbabilitiesShot.csv', function(dataOriginProbabilitiesShotFor) {
                    ...
                    d3.csv('./Data/' + typeOfDataset.replace(/_/g,'/') + 'OriginScale.csv', function(dataOriginScale) {
                        ...
                        d3.csv('./Data/' + typeOfDataset.replace(/_/g,'/') + 'GranularScale.csv', function(dataGranularScale) {
                            ...
                            if ( setCode == 'Liverpool_For_Scoring_Team' & postCode == 'TeamScoringPost' ) { 
...
initiateSetChange = function(
    ...
    d3.selectAll('.plotTitle').text('Updating')
